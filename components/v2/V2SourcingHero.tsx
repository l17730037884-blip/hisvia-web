...
/* ============================================================
   HISVIA V2 Homepage — Manufacturing Search Hero
   Migrated from app/v4-preview (validated V4 hero design).
   UI structure unchanged from V4 prototype; site chrome
   (navbar/footer) is provided by the V2 layout.
...
/* ============================================================
   ...
   the library; component holds zero hardcoded /photos/ paths.
   ============================================================ */
...
export default function V2SourcingHero({ locale }: { locale: Locale }) {
  ...
  return (
    <section
      className="v4p relative flex min-h-[calc(100vh-68px)] items-center overflow-x-clip"
      style={{ background: BG, color: INK }}
      data-locale={locale}
    >
      <style dangerouslySetInnerHTML={{ __html: CSS }} />

      {/* hero — procurement entry + asset library product gallery */}
      <div className="relative mx-auto grid w-full max-w-[1280px] items-center gap-12 px-6 pb-20 pt-10 md:px-8 lg:grid-cols-[1.25fr_1fr] lg:gap-14 lg:pt-16">
            ...
            {GALLERY.map((g) => (
              <figure key={g.title} className="group relative overflow-hidden border bg-white" style={{ borderColor: LINE }}>
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  {showDebug && <AssetDebug res={g.res} />}
                  <span
